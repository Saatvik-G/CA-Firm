...
export const mockWebinars: Webinar[] = [
  {
    ...
    description: 'Technical session led by Principal CA Saatvik Gupta covering clause-by-clause Form 3CD compliance, MSME verification workpapers, and faceless assessment notice response strategy.',
    date: '2024-08-24',
    time: '11:00 AM - 01:00 PM IST',
    speaker: 'CA Saatvik Gupta',
    speakerDesignation: 'Proprietor & Principal CA (FCA, DISA)',
    status: 'past',
    recordingUrl: '#',
    presentationDeckUrl: '#',
    keyTakeaways: [
